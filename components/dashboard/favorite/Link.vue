...
import { CalendarPlus2, Copy, CopyCheck, Eraser, Hourglass, Link as LinkIcon, QrCode, SquareChevronDown, SquarePen, Star } from 'lucide-vue-next'
...
function toggleFavorite() {
  const updatedLink = { ...props.link, isFavorite: !props.link.isFavorite }
  emit('update:link', updatedLink, 'favorite')
  editPopoverOpen.value = false
}
</script>
